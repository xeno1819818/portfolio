...
| [Оценка А-В теста](/examination_A_B_test) |Нужно проверить корректность проведения А-В теста и провести его анализ|*pandas, numpy, matplotlib, seaborn, scipy, math, plotly*|
